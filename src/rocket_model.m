function [x_dot] = rocket_model(Hopper, x_b, thrust_prop_vec_b, torque_thrust_force_b, torque_prop_vec_b, dist_force_n, dist_torque_b)
    ...
    force_tot_b = thrust_prop_vec_b;
    force_tot_n = v_quatrotate(att_q_nb, force_tot_b) + mass_tot*g + dist_force_n;
