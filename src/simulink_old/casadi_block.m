classdef casadi_block < matlab.System & matlab.system.mixin.Propagates
    % Copied from tutorial https://web.casadi.org/blog/mpc-simulink/
    % Variable step NMPC
    % 
    ...
    methods (Access = protected)
        ...
        function setupImpl(obj,~,~)
            ...
            % Create an NLP solver to be used each time step
        ...
        function u = stepImpl(obj,x,t)
            % actually solve with x, t and already stored solver in obj
            disp(t)
            tic
            w0 = obj.x0;
            lbw = obj.lbx;
